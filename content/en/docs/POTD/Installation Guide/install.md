...
If it does not complete successfully (a red box with "Installation failed"), consult the [Troubleshooting](/docs/living-skyrim/troubleshooting/wjissues/) page of the readme, or visit the [Path of the Dovahkiin Discord server](https://discord.gg/thg2eRxf7z) for assistance. 
