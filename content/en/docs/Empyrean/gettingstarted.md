...
**The Empyrean installer file can be found here: [Click Me!](https://drive.google.com/drive/folders/1PZ9AoznRw3LxVMVzbZE-2GthJa0BPRu-?usp=drive_link)**
...
First things first, if you are using a 21x9 monitor, you will need to enable all of the Ultrawide Patches under Ultrawide Options (makes sense right?), otherwise the entire display will be off, and no one will have a good time. After you've done that, navigate to the drop down menu, and select ENB Organizer
