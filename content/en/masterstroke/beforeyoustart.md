...
- Archery Gameplay Overhaul: Overhauls the archery system to require more management and skill.
...
- Toys: Adds a bar under the health/stamina/magicka bar to monitor arousal.
...
- Toys Framework: A framework for NSFW equipment and managing of that equipment.
- Gossip: A framework for characters to gain NSFW fame in areas across the land.
...
- Toyful Temptations: When you loot a container, there's a chance to be equipped with various Toys.
...
- Toy Story: Adds an introductory questline to Toys and their functions.
